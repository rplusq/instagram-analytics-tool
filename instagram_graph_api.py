...
def getUserInsights( params ) :
    ...
    endpointParams = dict() # parameter to send to the endpoint
    endpointParams['metric'] = 'follower_count,impressions,profile_views,reach,email_contacts,get_directions_clicks,phone_call_clicks,text_message_clicks,website_clicks' # fields to get back
...
def getAudienceInsights( params ):
    """ Get insights for a users account audience
    ...
    endpointParams = dict() # parameter to send to the endpoint
    endpointParams['metric'] = 'online_followers,audience_city,audience_country,audience_gender_age,audience_locale' # fields to get back
    endpointParams['period'] = 'lifetime' # period
    endpointParams['access_token'] = params['access_token'] # access token
